...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmployeeSerializeDeserializePractice employee = new EmployeeSerializeDeserializePractice(
            "Suman",
            30,
            "john@mail.com",
            "asdfwew"
        ...
        EmployeeSerializeDeserializePractice data = gson.fromJson(result, EmployeeSerializeDeserializePractice.class);
